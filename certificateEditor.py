...
def edit_certificate(template_path, attendees_list, eventTitle, eventDate, font_path):
    list_of_jpgs_paths = []
    for index, name in enumerate(attendees_list):
        ...
        eventTitle_font_size = 25
        eventTitle_font = ImageFont.truetype(font_path, eventTitle_font_size)

        eventDate_font_size = 15
        eventDate_font = ImageFont.truetype(font_path, eventDate_font_size)
        ...
        eventTitle_startY = 320  # adjust these values as needed
